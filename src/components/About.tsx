          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              ...
              <div className="space-y-4 text-gray-600 dark:text-gray-300">
                <p>
                  I am a passionate and driven BSc(Hons) of Computing student at Belgium Campus ITversity, with a strong foundation in software engineering, web development, and data science. My academic journey has equipped me with hands-on experience in a variety of programming languages and frameworks, including JavaScript, TypeScript, React, Node.js, Python, and C#.
                </p>
                <p>
